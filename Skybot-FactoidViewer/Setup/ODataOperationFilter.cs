...
// Skybot.FactoidViewer / ODataOperationFilter.cs BY Kristian Schlikow
...
#region
    ...
    public class ODataOperationFilter : IOperationFilter
    {
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            if (context.ApiDescription.ActionDescriptor is not ControllerActionDescriptor descriptor || !descriptor.FilterDescriptors.Any(filter => filter.Filter is EnableQueryAttribute))
            {
                return;
            }
